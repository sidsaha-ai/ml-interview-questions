...
Example for $\mathbf{p = 3}$: For a vector $x = [3, -4, 5]$, $\vert{x}\vert = \root{\displaystyle{3}}\of{\vert{3}\vert^3 + \vert{-4}\vert^3 + \vert{5}\vert^3} = \root{\displaystyle{3}}\of{27 + 64 + 125}$
